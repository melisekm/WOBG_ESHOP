@extends("layout.app")
@section('title', 'WOBG - Privacy Policy')
@section("content")
    <main class="container pt-5">
        <h1 class="text-center"> Privacy Policy </h1>
        <!--    source: https://www.termsfeed.com/blog/sample-privacy-policy-template/-->
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
                    refers to World of Board Games, CUBICON, Mlynská dolina, 841 04 Bratislava.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to World of Board Games, accessible from <a href="#"
        ...
        <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile
            ...
            learn more about cookies here: <a href="https://www.termsfeed.com/privacy-policy-generator/#faq-8"
        ...
        <ul>
            <li>
                <p>By email: shop@wobg.com</p>
            </li>
            <li>
                <p>By phone number: +421 013 371 337</p>
            </li>
        </ul>
